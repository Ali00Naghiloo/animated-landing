...
export default function Body() {
    ...
    return (
      ...
      >
        <MyButton
          ...
          className={
            "buttons hover:bg-[#77A9E8] text-[1.3em] hover:shadow-[0_0_50px_#77A9E8] px-[43px] py-[14px] mb-auto lg:mb-0 backdrop-blur-[10px]"
          }
          variant=""
          onClick={() => {
  ...
  return (
    <AnimatePresence mode="sync">
      ...
      <motion.div
        ref={ref}
        className="w-full h-full flex flex-col lg:gap-10 items-center justify-between relative"
      >
        {/* gif */}
        <motion.div
          initial={{ scale: 0.5 }}
